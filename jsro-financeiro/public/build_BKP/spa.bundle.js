...
/***/ (function(module, exports, __webpack_require__) {
	...
	var appConfig = Object.assign({}, localConfig, _config2.default);
...
/***/ (function(module, exports) {
	...
	module.exports = {
		api_url: 'http://192.168.10.10:8000/api',
		app_path: '/app',
		login_path: '#!/login'
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jwtToken = __webpack_require__(19);
	...
	Vue.http.interceptors.push(function (request, next) {
	    request.headers.set('Authorization', _jwtToken2.default.getAuthorizationHeader());
	    next();
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _localStorage = __webpack_require__(21);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    user: {
	        ...
	        get data() {
	            if (!this._data) {
	                this._data = _localStorage2.default.getObject(_resources.User);
	            }
	            return this._data;
	        },
	...
	exports.default = {
	    data: function data() {
	        return {
	            ...
	            menusDropdown: [{
	                id: 'teste',
	                items: [{ name: "Listar Contas", routeNmae: 'auth.login' }, { name: "Criar Contas", routeNmae: 'auth.login' }]
	            }],
	            user: _auth2.default.user
	        };
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Logout = __webpack_require__(38);
	    ...
	    methods: {
	        login: function login() {
	            ...
	            _auth2.default.login(this.user.email, this.user.password).then(function () {
	                return _this.$router.go({ name: 'dashboard' });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-c79388a2/Dashboard.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
