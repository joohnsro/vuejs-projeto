...
/******/ 	var hotCurrentHash = "4d5a14bb49b74b24d131"; // eslint-disable-line no-unused-vars
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] src/js/BillDashboard.vue: named exports in *.vue files are ignored.")}
...
if (true) {(function () {  module.hot.accept()
  ...
  hotAPI.install(__webpack_require__(0), false)
  if (!hotAPI.compatible) return
  var id = "_v-46434141/BillDashboard.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] src/js/bill-pay/BillPay.vue: named exports in *.vue files are ignored.")}
...
if (true) {(function () {  module.hot.accept()
  ...
  hotAPI.install(__webpack_require__(0), false)
  if (!hotAPI.compatible) return
  var id = "_v-0b9f3bf0/BillPay.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] src/js/bill-pay/BillPayCreate.vue: named exports in *.vue files are ignored.")}
...
if (true) {(function () {  module.hot.accept()
  ...
  hotAPI.install(__webpack_require__(0), false)
  if (!hotAPI.compatible) return
  var id = "_v-72bf790c/BillPayCreate.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] src/js/bill-pay/BillPayList.vue: named exports in *.vue files are ignored.")}
...
if (true) {(function () {  module.hot.accept()
  ...
  hotAPI.install(__webpack_require__(0), false)
  if (!hotAPI.compatible) return
  var id = "_v-2a1b34a4/BillPayList.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] src/js/bill-receive/BillReceive.vue: named exports in *.vue files are ignored.")}
...
if (true) {(function () {  module.hot.accept()
  ...
  hotAPI.install(__webpack_require__(0), false)
  if (!hotAPI.compatible) return
  var id = "_v-cdd42434/BillReceive.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] src/js/bill-receive/BillReceiveCreate.vue: named exports in *.vue files are ignored.")}
...
if (true) {(function () {  module.hot.accept()
  ...
  hotAPI.install(__webpack_require__(0), false)
  if (!hotAPI.compatible) return
  var id = "_v-d82b4afc/BillReceiveCreate.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] src/js/bill-receive/BillReceiveList.vue: named exports in *.vue files are ignored.")}
...
if (true) {(function () {  module.hot.accept()
  ...
  hotAPI.install(__webpack_require__(0), false)
  if (!hotAPI.compatible) return
  var id = "_v-cd99a6b8/BillReceiveList.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
router.map({
    '/': {
        ...
        subRoutes: {
            '/': {
                name: 'dashboard',
                component: _BillDashboard2.default
            },
            '/bill-pays': {
...
module.exports = {
    ...
    methods: {
        getTotalBillsPays: function getTotalBillsPays() {
            ...
            resource.BillPayResource.totalDone().then(function (response) {
        ...
        getTotalBillsReceives: function getTotalBillsReceives() {
            ...
            resource.BillReceiveResource.totalDone().then(function (response) {
...
exports.default = {
    ...
    methods: {
        ...
        updateStatus: function updateStatus() {
            ...
            resource.BillPayResource.query().then(function (response) {
        ...
        updateTotal: function updateTotal() {
            ...
            resource.BillPayResource.totalNotDone().then(function (response) {
...
var _bill = __webpack_require__(4);
    ...
    methods: {
        submit: function submit() {
            ...
            if (this.$route.name == 'bill-pay.create') {
                resource.BillPayResource.save(data).then(function (response) {
                    _this.$dispatch('update-info');
                    _this.$router.go({ name: 'bill-pay.list' });
                });
            } else {
                resource.BillPayResource.update({ id: this.bill.id }, data).then(function (response) {
                    _this.$dispatch('update-info');
                    _this.$router.go({ name: 'bill-pay.list' });
                });
            }
        ...
        getBill: function getBill(id) {
            ...
            resource.BillPayResource.get({ id: id }).then(function (response) {
...
exports.default = {
    ...
    created: function created() {
        ...
        resources.BillPayResource.query().then(function (response) {
    ...
    methods: {
        billDelete: function billDelete() {
            ...
            resources.BillPayResource.delete({ id: this.billToDelete.id }).then(function (response) {
...
exports.default = {
    ...
    methods: {
        ...
        updateStatus: function updateStatus() {
            ...
            resource.BillReceiveResource.query().then(function (response) {
                _this.countBills(response.data);
            });
        },
        updateTotal: function updateTotal() {
            ...
            resource.BillReceiveResource.totalNotDone().then(function (response) {
                _this2.total = response.data.total;
            });
        }
    },
    ...
    methods: {
        submit: function submit() {
            ...
            if (this.$route.name == 'bill-receive.create') {
                resource.BillReceiveResource.save(data).then(function (response) {
                    _this.$dispatch('update-info');
                    _this.$router.go({ name: 'bill-receive.list' });
                });
            } else {
                resource.BillReceiveResource.update({ id: this.bill.id }, data).then(function (response) {
                    _this.$dispatch('update-info');
                    _this.$router.go({ name: 'bill-receive.list' });
                });
            }
        ...
        getBill: function getBill(id) {
            ...
            resource.BillReceiveResource.get({ id: id }).then(function (response) {
                _this2.bill = new _bill.BillPay(response.data);
            });
        }
    }
...
exports.default = {
    ...
    created: function created() {
        ...
        resources.BillReceiveResource.query().then(function (response) {
            _this.bills = response.data;
            _this.$dispatch('update-info');
        });
    },
    ...
    methods: {
        billDelete: function billDelete() {
            ...
            resources.BillReceiveResource.delete({ id: this.billToDelete.id }).then(function (response) {
                _this2.bills.$remove(_this2.billToDelete);
                _this2.billToDelete = null;
                Materialize.toast('Conta excluída com sucesso. <i class="material-icons right">done</i>', 4000);
                _this2.$dispatch('update-info');
